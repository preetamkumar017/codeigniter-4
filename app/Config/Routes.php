...
$routes->get('/error_403', function() {
    return redirect()->to('/')->with('error', 'Forbidden')->setStatusCode(403);
});
...
$routes->get('hr/profile/personal_info', 'HR\Profile\PersonalIformationController::index', ['filter' => 'authGuard']);
